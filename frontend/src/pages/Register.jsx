...
export default function Register() {
  ...
  const submit = async (event) => {
    ...
    if (!form.username.trim()) return setError('Ingresa tu nombre de usuario')
  ...
  return (
    <section className="mx-auto max-w-md">
      <form onSubmit={submit} className="glass-panel rounded-lg p-6">
        ...
        <p className="mt-2 text-sm text-slate-400">Crea tu cuenta ULIMA para publicar y acceder al perfil.</p>
        <div className="mt-6 space-y-4">
          ...
          <input
            className="w-full rounded-md border border-white/10 bg-[#171a1a] px-3 py-2 outline-none focus:border-[#ff4b00]"
            placeholder="correo@ulima.edu.pe"
            value={form.email}
